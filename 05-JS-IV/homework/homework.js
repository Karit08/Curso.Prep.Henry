...
function eliminarPropiedad(objeto, unaPropiedad) {
  ...
  // Devuelve el objeto
  // Tu código:
  delete objeto[unaPropiedad]; // se elimina la propiedad 
  return objeto;
}
...
function nuevoUsuario(nombre, email, password) {
  ...
  // Tu código:
 var objeto = {
   nombre: nombre, // es lo mismo que decir nombre 
   email: email,
   password: password
 }
 return objeto;
...
function tienePropiedad(objeto, propiedad) {
  ...
  // Tu código:
  if (objeto[propiedad]){ //si quiero saber si la propiedad existe la pasan como argumento 
    return true 
  }else {
    return false 
  }
...
function agregarMetodoCalculoDescuento(producto) {
  ...
  return producto;
  //return this.precio - this.precio * tris.porcentajeDeDescuento; 
  //this apunta al objeto global, objeto producto, en donde estamos parados
}
